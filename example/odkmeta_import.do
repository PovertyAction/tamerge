* Created on January 28, 2016 at 12:46:50 by the following -odkmeta- command:
* odkmeta using "odkmeta_import.do", csv("Sample Form - Auditing.csv")                                    survey("survey.csv")                                                                    choices("choices.csv")                                                                    replace
...
* surveyor
char surveyor[Odk_name] surveyor
char surveyor[Odk_bad_name] 0
char surveyor[Odk_long_name] surveyor
char surveyor[Odk_type] select_one surveyor
char surveyor[Odk_list_name] surveyor
char surveyor[Odk_or_other] 0
char surveyor[Odk_is_other] 0
char surveyor[Odk_label] SURVEYOR: Please select your name from the list below.
char surveyor[Odk_required] yes
